 ...
 */
package com.zeewain.cbb.netty.protocol.compress;


import com.zeewain.cbb.netty.protocol.util.IOUtil;
...
public class GzipCompressor implements Compressor {
     ...
     */
    public static byte[] pack(final byte[] src) throws IOException {
        byte[] result;
     ...
     * @throws IOException the io exception
     */
    public static byte[] upack(final byte[] src) throws IOException {
        byte[] result;
