...
import static com.zeewain.cbb.netty.core.NettyProperties.explicitFlushAfterFlushes;
...
public class ClientSocketProtocolHandler implements ProtocolHandler {
    ...
    protected void initSocketHandler(ChannelPipeline pipeline) {
        ...
        pipeline.addLast(new FlushConsolidationHandler(explicitFlushAfterFlushes, true));
